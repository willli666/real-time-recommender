...
for google, to get into the pod's sh environment
kubectl exec -it nimbus -c nimbus sh 
yum install wget git zip sbt
...
on fedral use yum install -y nmap to install nc (netcat)
...
check the LoadBalancer Ingress and NodePort, use them in kafka-broker
https://dzone.com/articles/ultimate-guide-to-installing-kafka-docker-on-kuber
then test with kafka cat  https://github.com/edenhill/kafkacat
kafkacat -b 34.69.248.124:9092 -t admintome-test
cat README | kafkacat -b 34.69.248.124:9092 -t admintome-test
kafkacat -L -b 34.69.248.124:9092